...
const GalleryComp = () => {
  ...
  return (
    <div>
        <TitleComp title={"Galeri"} subText={"Diş kliniğimizdeki modern teknoloji ve rahat ortamımızı keşfedin. Başarılı tedavi süreçlerimizi ve mutlu hastalarımızın gülümsemelerini galerimizde bulabilirsiniz."}/>
      <Image.PreviewGroup>
        <Row gutter={[16, 16]}>
